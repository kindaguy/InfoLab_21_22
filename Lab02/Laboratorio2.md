# Laboratorio 2: Hello world, overflow, precisione, MCD, ciclo precondizionale.
...
- convenzionalmente il file sorgente si indica con estensione .C oppure .cpp oppure .cxx. Questo consente, tra l'altro, anche all'editor di inferire la tipologia di contenuto del file e evidenziare la sintassi.
